...
public class DataSeeder implements CommandLineRunner {
        ...
        private void crearRespuestas() {
                ...
                for (int i = 0; i < preguntas.size(); i++) {
                        ...
                        String[] respuestas = respuestasFake[i];
                        ...
                        for (int j = 0; j < respuestas.length; j++) {
                                ...
                                if (pregunta.getStatus() == Status.RESUELTA
                                                &&
                                                j == 0) {
        ...
        private LocalDateTime generarFechaRespuesta(
                        LocalDateTime fechaPregunta) {
